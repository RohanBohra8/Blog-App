...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      //https://motionless-fox-life-jacket.cyclic.app  || /api/v1/user/register
      const { data } = await axios.post("https://motionless-fox-life-jacket.cyclic.app/api/v1/user/register", {
